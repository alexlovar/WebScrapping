...
namespace CarScraping
{
    public partial class FormMain : Form
    {
        ...
        string _baseFolderPath = "c:/scrap_data";
        ...
        private void Init()
        {
            ...
            _webScrap.Init(webBrowser0);
            string urlLang = "http://platesmania.com/?&lang=en";
            webBrowser0.Navigate(urlLang);
        ...
        private void buttonScrap0_Click(object sender, EventArgs e)
        {
            ...
            Console.WriteLine("Finished to scrap.");
